...
export const getAllWeekRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/thisweek'
...
export const getAllMonthRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/allmonths'
...
export const getTodaysRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/daily'
...
export const getThisWeeksRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/weekly'
...
export const getThisMonthsRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/monthly'
...
export const getThisYearsRevenue = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8074/revenue/yearly'
